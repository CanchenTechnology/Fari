...
public class FriendMoveUIComponent:MonoBehaviour
{
	public WindowLayer windowLayer = WindowLayer.Debug;
	...
	public void InitComponent(WindowBase target)
	{
	    ...
	    FriendMoveUI mWindow=(FriendMoveUI)target;
