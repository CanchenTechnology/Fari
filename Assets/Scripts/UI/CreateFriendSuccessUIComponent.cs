...
public class CreateFriendSuccessUIComponent:MonoBehaviour
{
	...
	public void InitComponent(WindowBase target)
	{
	    ...
	    CreateFriendSuccessUI mWindow=(CreateFriendSuccessUI)target;
	    ...
	    target.AddButtonClickListener(EnterConversationButton,mWindow.OnEnterConversationButtonClick);
	    target.AddButtonClickListener(BackToFriendsButton,mWindow.OnBackToFriendsButtonClick);
	}
}
