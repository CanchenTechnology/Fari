...
public class SwitchRoleUIComponent:MonoBehaviour
{
	public WindowLayer windowLayer = WindowLayer.MainUI;
	public Button exitButton;
	public GamerUIListView roleGamerUIListView;
	public void InitComponent(WindowBase target)
	{
	    //组件事件绑定
	    target.Canvas.sortingOrder = (int)windowLayer;
	    target.Layer = windowLayer;
	    SwitchRoleUI mWindow=(SwitchRoleUI)target;
