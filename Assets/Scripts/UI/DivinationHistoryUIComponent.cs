...
public class DivinationHistoryUIComponent:MonoBehaviour
{
	...
	public Text MetaTypeValueText;
	public Text MetaTargetValueText;
	public Text MetaOracleValueText;
	public Text MetaTimeValueText;
	public Text MetaStatusValueText;
	public Text OracleTextText;
	public Text AdviceTextText;
	public Text SummaryTextText;
