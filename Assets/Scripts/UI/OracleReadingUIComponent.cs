...
public class OracleReadingUIComponent:MonoBehaviour
{
	...
	public void InitComponent(WindowBase target)
	{
	    ...
	    OracleReadingUI mWindow=(OracleReadingUI)target;
	    target.AddButtonClickListener(SwitchOracleButton,mWindow.OnSwitchOracleButtonClick);
	    target.AddButtonClickListener(anyWhereBtnButton,mWindow.OnanyWhereBtnButtonClick);
	}
}
