...
namespace SuperScrollView
{
    ...
    public class LoopListViewInitParam
    {
        ...
        public float mSmoothDumpRate = 0.3f;//滚动速率0-1 速率越小，滚动切换越快(常用于分页滚动)
        public float mSnapFinishThreshold = 0.01f;//自适应吸附完成的阈值，完成后会触发SnapFinish回调，值越大吸附完成越早，越小越平滑(常用于分页滚动)
        public float mSnapVecThreshold = 145; //自适应吸附的阈值，当ScrollView.velocity速度小于这个值是会自动吸附适应。常作用于分页滚动(常用于分页滚动)
        /// <summary>
        /// Item对象的默认尺寸（宽度或高度，取决于垂直或水平布局）。 当Item的大小未显式设置时使用
        /// </summary>
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        /// <summary>
        /// 承载所有 Item 的实际可视区域容器,应该是Content
        /// </summary>
        ...
        public bool ListViewInited { get { return mListViewInited; } }
        ...
        */
        ...
        /*
            此方法可用于在运行时设置滚动视图的item总数。
            如果此参数设置为-1，则表示item数量无限，
            ...
            注意:在调用完成后需要调用RefreshAllShownItem()刷新当前数据的最新状态
        */
