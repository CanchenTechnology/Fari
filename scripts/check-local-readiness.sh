...
for export_name in membershipStatus readinessStatus publicConfig submitFeedback adminPublicConfigUpdate adminModelQuotaStatus adminProviderSecretUpdate adminProviderKeyPoolAdd adminProviderKeyPoolSelect adminProviderKeyPoolDelete adminProviderKeyPoolStatusUpdate adminProviderKeyPoolResetFailures adminProviderKeyPoolMetadataUpdate adminProviderKeyPoolCheck adminProviderKeyPoolCheckAll adminProviderKeyEvents scheduledProviderKeyHealthCheck adminProviderKeyHealthRuns adminProviderKeyHealthRunNow cleanupProviderKeyMaintenanceData adminProviderKeyMaintenanceCleanupNow adminFeedbackList adminFeedbackUpdate deleteMyAccountData submitIapReceipt aiChat aiChatStream processStaleDialogueReplyJobs ttsSynthesize; do
